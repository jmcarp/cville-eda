...
bq load --autodetect --replace whatthecarp:cville_eda.real_estate_sales real-estate-sales.csv
bq load --autodetect --replace whatthecarp:cville_eda.parcel_area_details parcel-area-details.csv
